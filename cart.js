...
function load_cart_price_total() {
  ...
  document.querySelector('.js-total-price-products').innerHTML = `$ ${totalcartprice ? totalcartprice : 0}`;
}
  ...
  cp.forEach((item) => {
    ...
    <div class="cart-single-product">
                ...
                <div class="cart-single-desc">
                    ...
                    <p>Quantity : ${item.productSize}</p>
                    <p>Price : $ ${item.productPrice ? item.productPrice : 0}</p>
